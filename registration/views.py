...
def generate_deep_link(request):
    ...
    play_store_link = "https://play.google.com/store/apps/details?id=com.siancesoftware.Mitra"

    deep_link_params = {'referrer': referral_code}
    deep_link = f"{play_store_link}&{urlencode(deep_link_params)}"
